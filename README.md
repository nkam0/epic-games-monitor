...
1. **Create a Mailgun account** at mailgun.com and add/verify a sending domain
2. **Create a GitHub repository** and push these files
3. **Add 4 secrets** to GitHub (`MAILGUN_API_KEY`, `MAILGUN_DOMAIN`, `MAILGUN_FROM`, `RECIPIENT_EMAIL`)
...
- **Email Provider**: Mailgun (HTTP API)
